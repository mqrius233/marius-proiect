    ...
    <div className="  bg-white w-full h-[700px]  ">
      <div className=" mx-[150px] mt-[100px]  h-[520px]">
        ...
        <div className="mx-[420px] grid grid-cols-4 gap-10 pt-10">
          <div className="flex h-80 w-64 flex-shrink-0 flex-col items-center justify-start gap-2 overflow-hidden rounded-2xl bg-orange-50 px-4 py-2 text-slate-950">
