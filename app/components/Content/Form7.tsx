...
export default function Form7() {
  return (
    <div className=" bg-white w-full h-[800px]">
      <div className=" mt-[48px] ml-[800px] text-black flex w-[734px] flex-col flex-shrink-0 text-[40px] font-extrabold not-italic leading-5">
        Contact us
      </div>
      <div className=" text-[#6B7280;] mt-8 ml-[800px] flex w-[509px] flex-col flex-shrink-0 text-[16px] not-italic font-normal leading-7">
      ...
      <div className="flex mt-[51px]">
        <div className=" ml-[700px]   bg-[#FDF1DC] w-[470px] h-[463px] rounded-2xl">
          ...
          <div className=" flex text-[16px] not-italic font-normal leading-7 text-black mt-[56px] ">
            ...
            <div className="ml-[25px]">+40 233 433 933</div>
          </div>
          ...
          <div className=" mt-[21px]  w-[337px] h-[196px]">
            <div className=" flex mt-[29px] text-black">
              ...
              <div className="ml-[25px]">academy@ivfuture.uk</div>
            </div>
            <div className="w-[300px] flex  flex-shrink-0 text-black mt-[50px]  text-[14px] font-normal not-italic leading-6">
              ...
              <div className="ml-[25px]">
                Portului Nr. 7, 800032, Galati, Galati Romania
              </div>
            </div>
          </div>
        ...
        <div className=" ml-[80px] mt-[75px] grid grid-cols-2 gap-x-[5px]">
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              className="appearance-none block w-[300px] text-[#8D8D8D]  border-b-2 border-[#8D8D8D] py-3 px-4 mb-3 "
              type="text"
          ...
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <input
              className="appearance-none block w-[600px] text-[#8D8D8D]  border-b-2 border-[#8D8D8D] py-3 px-4 mb-3 "
              type="text"
          ...
          <div className="mt-[150px] ">
            <button className=" text-white  rounded-[8px]   flex  py-[16px] px-[48px] justify-center items-center gap-[10px] bg-orange-600   shadow-custom-shadow">
              Enroll Now!
              <Image
                className=" w-6 h-6"
                src="/Arrow.png"
